  ...
  return (
    <>
     ...
     transition-all duration-300 ${
      ...
      >
        <div className="container max-w-7xl 3xl:max-w-450 4xl:max-w-500 mx-auto flex items-center justify-between">
      ...
      <div
        aria-hidden={!isOpen}
        className={`fixed inset-0 z-50 flex flex-col justify-between bg-landing-bg/90 p-8 md:p-16 backdrop-blur-3xl transition-all duration-500 ease-in-out ${
          isOpen
        ...
        <div className="mt-24 flex flex-col gap-6">
          {[
            ...
            <a
              ...
              className="font-display text-4xl md:text-7xl font-bold uppercase tracking-tight text-white/40 hover:text-landing-violet-400 transition-all duration-300 hover:translate-x-3"
            >
              0{idx + 1}. {item}
            </a>
          ))}
